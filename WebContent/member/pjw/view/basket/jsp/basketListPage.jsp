...
<script type="text/javascript">
	$(document).ready(function() {
		...
		// 			if ( event.which == 13 ) {
		// 			alert("event.which:"+event.which+$(this).val());
		// 				location.href = encodeURI("productlistbykeyword?keyword="+$(this).val());
		// 			}			
		// 		});
	});
</script>
			...
			<div class="collapse navbar-collapse" id="navbarsExample04">
				<ul class="navbar-nav mr-auto">
					<li class="nav-item <%-- active--%>"><a class="nav-link"
						href="productlistbycategoryPage?cid=1">농구화<span class="sr-only">(current)</span></a>
					</li>
				...
				<table class="table table-bordered table-sm">
					...
					<tbody>
						<tr>
							...
							<td>에어맥스11</td>
							<td>
								<input class="pamount" type="text">
								<input class="btn_change_pamount" type="button" value="변경">
							</td>
							<td rowspan="2">
								<span class="pdcharge">2,500원</span><br>
								주문시결제
							</td>
							<td><span class="pprice">200,000원</span></td>
					...
					<tfoot class="thead-light">
						...
						<tr>							
							<th>배송비</th>							
							<th colspan="2"><span id="dcharge"></span></th>						
						</tr>
						<tr>							
							<th>결제금액</th>							
							<th colspan="2"><span id="ptotal"></span></th>						
						</tr>
					</tfoot>
				</table>
				</form>
